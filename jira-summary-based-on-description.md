...
- the summary shouldn't be larger than 47 characters
- you should also give me an english more larger explanation of the task
example:
...
example jira summaries:
- [Notification] as a user, I can receive Notification reminder for signatures via Email and Alerts
- [DATA GROUPS] - Process fat file for the User should be able to upload a fixed-width flat file
